...
export const Route = createFileRoute('/explorer-enhanced')({
  component: EnhancedExplorer,
})

function EnhancedExplorer() {
          ...
          {(isDesktop || activeTab === 'files') && !fileTreeCollapsed && (
            <div className="w-80 border-r border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 flex flex-col">
              <ExplorerFileTreePanels
                ...
                onToggleFolder={(path) => {
                  // TODO: Implement folder toggling for integrated system
                }}
              />
